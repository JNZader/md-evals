...
from md_evals.models import EvalConfig, ExecutionResult, LLMResponse, EvaluatorResult
...
class TestReporter:
        ...
        results = [
            ExecutionResult(
                ...
                response=LLMResponse(
                    content="Hi", model="gpt-4o", provider="openai", duration_ms=1000
                ),
                passed=True,
                evaluator_results=[],
            ...
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hi", model="gpt-4o", provider="openai", duration_ms=2000
                ),
                passed=False,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:00",
    ...
    def test_report_terminal_verbose(self):
        ...
        results = [
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hi there!", model="gpt-4o", provider="openai", duration_ms=1000
                ),
                passed=True,
                evaluator_results=[
                    EvaluatorResult(
    ...
    def test_report_terminal_multiple_treatments(self):
        ...
        results = [
            ...
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hello!", model="gpt-4o", provider="openai", duration_ms=1200
                ),
                passed=True,
                evaluator_results=[],
            ...
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hi", model="gpt-4o", provider="openai", duration_ms=1500
                ),
                passed=False,
                evaluator_results=[],
    ...
    def test_report_terminal_partial_pass(self):
        ...
        results = [
            ...
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hi", model="gpt-4o", provider="openai", duration_ms=1200
                ),
                passed=False,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:01",
    ...
    def test_report_terminal_no_response(self):
        ...
        results = [
            ExecutionResult(
                ...
                test="test1",
                prompt="Hello",
                response=LLMResponse(content="", model="error", provider="error", duration_ms=0),
                passed=False,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:00",
            )
    ...
    def test_report_json(self, tmp_path):
        ...
        config = EvalConfig(name="Test", output__results_dir=str(tmp_path))
        reporter = Reporter(config)
    ...
    def test_report_json_creates_directory(self, tmp_path):
        ...
        config = EvalConfig(name="Test", output__results_dir=str(results_dir))
        reporter = Reporter(config)
    ...
    def test_build_output_data_structure(self):
        ...
        results = [
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hi", model="gpt-4o", provider="openai", tokens=10, duration_ms=1000
                ),
                passed=True,
                evaluator_results=[
                    EvaluatorResult(
                        evaluator_name="regex_eval", passed=True, score=1.0, reason="Matched"
                    )
                ],
                timestamp="2024-01-01T00:00:00",
            )
    ...
    def test_build_markdown_contains_evaluators(self):
        ...
        results = [
            ExecutionResult(
                ...
                passed=True,
                evaluator_results=[
                    EvaluatorResult(evaluator_name="regex_check", passed=True, score=1.0)
                ],
                timestamp="2024-01-01T00:00:00",
            )
        ]
    ...
    def test_report_json_has_summary_statistics(self):
        ...
        results = [
            ...
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hi", model="gpt-4o", provider="openai", tokens=15, duration_ms=1500
                ),
                passed=False,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:00",
    ...
    def test_calculate_summary_duration_stats(self):
        ...
        results = [
            ...
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hi", model="gpt-4o", provider="openai", tokens=20, duration_ms=2000
                ),
                passed=True,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:00",
    ...
    def test_calculate_summary_single_treatment(self):
        ...
        results = [
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hi", model="gpt-4o", provider="openai", tokens=50, duration_ms=1000
                ),
                passed=True,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:00",
    ...
    def test_calculate_summary(self):
        ...
        results = [
            MagicMock(treatment="CONTROL", passed=True, response=mock_response),
            MagicMock(treatment="CONTROL", passed=False, response=mock_response),
            MagicMock(treatment="WITH_SKILL", passed=True, response=mock_response),
        ]
...
class TestReportMarkdown:
    ...
    def test_build_markdown(self, tmp_path):
        """Test markdown report generation."""
        config = EvalConfig(name="Test", version="1.0", output__results_dir=str(tmp_path))
        reporter = Reporter(config)
    ...
    def test_report_terminal_duration_milliseconds(self, capsys):
        ...
        results = [
            ExecutionResult(
                ...
                prompt="test",
                response=LLMResponse(
                    content="response", model="gpt-4o", provider="openai", duration_ms=1500
                ),
                passed=True,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:00",
            ...
            ExecutionResult(
                ...
                prompt="test",
                response=LLMResponse(
                    content="response", model="gpt-4o", provider="openai", duration_ms=2500
                ),
                passed=True,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:00",
    ...
    def test_report_terminal_duration_single_result(self, capsys):
        ...
        results = [
            ExecutionResult(
                ...
                prompt="test",
                response=LLMResponse(
                    content="response", model="gpt-4o", provider="openai", duration_ms=5000
                ),
                passed=True,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:00",
    ...
    def test_duration_calculation_with_mixed_values(self):
        ...
        results = [
            ...
            ExecutionResult(
                ...
                prompt="test",
                response=LLMResponse(
                    content="response", model="gpt-4o", provider="openai", duration_ms=200
                ),
                passed=True,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:00",
            ...
            ExecutionResult(
                ...
                prompt="test",
                response=LLMResponse(
                    content="response", model="gpt-4o", provider="openai", duration_ms=300
                ),
                passed=True,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:00",
    ...
    def test_markdown_formatting_mutation(self, tmp_path):
        ...
        results = [
            ...
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hi", model="gpt-4o", provider="openai", duration_ms=1100
                ),
                passed=True,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:01",
    ...
    def test_treatment_grouping_mutation(self):
        ...
        results = [
            ...
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hi", model="gpt-4o", provider="openai", duration_ms=900
                ),
                passed=True,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:00",
            ...
            ExecutionResult(
                ...
                prompt="Hello",
                response=LLMResponse(
                    content="Hi", model="gpt-4o", provider="openai", duration_ms=950
                ),
                passed=True,
                evaluator_results=[],
                timestamp="2024-01-01T00:00:01",
...
class TestReporterOutputFormatProperties:
        ...
        for i in range(num_results):
            results.append(
                ExecutionResult(
                    ...
                    prompt=f"Prompt {i}",
                    response=LLMResponse(
                        content=f"Response {i}", model="gpt-4o", provider="openai", duration_ms=100
                    ),
                    passed=True,
                    evaluator_results=[],
                    timestamp="2024-01-01T00:00:00",
    ...
    @given(num_results=st.integers(min_value=1, max_value=50))
    @settings(suppress_health_check=[HealthCheck.filter_too_much])

...
class TestRegexEvaluator:
    ...
    def test_pattern_matches(self):
        ...
        evaluator = RegexEvaluator(name="has_hello", pattern="hello", pass_on_match=True)
    ...
    def test_pattern_not_matches(self):
        ...
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(name="has_hello", pattern="goodbye", pass_on_match=True)
    ...
    def test_pass_on_match_false(self):
        ...
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(name="no_hello", pattern="hello", pass_on_match=False)
    ...
    def test_invalid_regex(self):
        """Test invalid regex."""
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(name="invalid", pattern="[invalid", pass_on_match=True)
    ...
    def test_multiline_pattern(self):
        ...
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(name="starts_with", pattern="^Hello", pass_on_match=True)
...
class TestExactMatchEvaluator:
    ...
    def test_exact_match(self):
        """Test exact match."""
        engine = EvaluatorEngine()
        evaluator = ExactMatchEvaluator(name="exact", expected="hello", case_sensitive=True)
    ...
    def test_case_insensitive(self):
        ...
        engine = EvaluatorEngine()
        evaluator = ExactMatchEvaluator(name="exact", expected="hello", case_sensitive=False)
    ...
    def test_no_match(self):
        """Test no match."""
        engine = EvaluatorEngine()
        evaluator = ExactMatchEvaluator(name="exact", expected="goodbye", case_sensitive=True)
    ...
    def test_empty_expected(self):
        ...
        engine = EvaluatorEngine()
        evaluator = ExactMatchEvaluator(name="exact", expected="", case_sensitive=True)
...
class TestCreateEvaluator:
    ...
    def test_create_regex_evaluator(self):
        ...
        evaluator = create_evaluator("regex", name="test", pattern="hello", pass_on_match=True)
    ...
    def test_create_exact_match_evaluator(self):
        ...
        evaluator = create_evaluator(
            "exact-match", name="test", expected="hello", case_sensitive=True
        )
...
class TestRegexEvaluatorEdgeCases:
    ...
    def test_case_insensitive_pattern(self):
        ...
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(name="case_test", pattern="hello", pass_on_match=True)
    ...
    def test_pattern_with_special_chars(self):
        ...
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(name="special_chars", pattern=r"\d+", pass_on_match=True)
    ...
    def test_pattern_with_word_boundary(self):
        ...
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(name="word_boundary", pattern=r"\bhello\b", pass_on_match=True)
    ...
    def test_pass_on_match_false_with_match(self):
        ...
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(name="negative", pattern="error", pass_on_match=False)
    ...
    def test_regex_with_optional_group(self):
        ...
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(name="optional", pattern=r"hello(\s+world)?", pass_on_match=True)
    ...
    def test_regex_multiline_with_anchors(self):
        ...
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(name="multiline", pattern="^success", pass_on_match=True)
    ...
    def test_evaluator_name_returned(self):
        ...
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(name="my_evaluator", pattern="test", pass_on_match=True)
    ...
    def test_default_fail_message_when_no_match(self):
        ...
        engine = EvaluatorEngine()
        evaluator = RegexEvaluator(
            name="test", pattern="nonexistent", pass_on_match=True, fail_message=None
        )
...
class TestExactMatchEvaluatorEdgeCases:
    ...
    def test_exact_match_full_string(self):
        ...
        engine = EvaluatorEngine()
        evaluator = ExactMatchEvaluator(name="exact", expected="exact match", case_sensitive=True)
    ...
    def test_exact_match_in_longer_string(self):
        ...
        engine = EvaluatorEngine()
        evaluator = ExactMatchEvaluator(name="exact", expected="test", case_sensitive=True)
    ...
    def test_special_chars_in_expected(self):
        ...
        evaluator = ExactMatchEvaluator(
            name="exact", expected="test@example.com", case_sensitive=True
        )
    ...
    def test_exact_match_evaluator_name(self):
        ...
        engine = EvaluatorEngine()
        evaluator = ExactMatchEvaluator(name="my_exact_test", expected="test", case_sensitive=True)
    ...
    def test_exact_match_score_on_fail(self):
        ...
        engine = EvaluatorEngine()
        evaluator = ExactMatchEvaluator(name="exact", expected="missing", case_sensitive=True)
...
class TestEvaluatorEngineIntegration:
    ...
    async def test_evaluate_single_regex(self):
        ...
        engine = EvaluatorEngine()
        evaluators = [RegexEvaluator(name="test", pattern="hello", pass_on_match=True)]
...
class TestEvaluatorRefinements:
    ...
    def test_evaluate_exact_match_boundary_case_sensitive(self):
        ...
        evaluator = ExactMatchEvaluator(name="test", expected="Hello", case_sensitive=True)
    ...
    def test_evaluate_exact_match_boundary_case_insensitive(self):
        ...
        evaluator = ExactMatchEvaluator(name="test", expected="Hello", case_sensitive=False)
    ...
    def test_evaluate_regex_boundary_match_vs_no_match(self):
        ...
        evaluator_pass = RegexEvaluator(name="test", pattern="hello", pass_on_match=True)
    ...
    def test_evaluate_regex_boundary_pass_on_match_false(self):
        ...
        evaluator_fail = RegexEvaluator(name="test", pattern="error", pass_on_match=False)
    ...
    def test_evaluate_exact_match_empty_string(self):
        ...
        evaluator = ExactMatchEvaluator(name="test", expected="", case_sensitive=True)
    ...
    def test_evaluate_regex_empty_pattern(self):
        ...
        evaluator = RegexEvaluator(name="test", pattern="", pass_on_match=True)
...
class TestScoreNormalizationMutations:
    ...
    def test_evaluator_result_score_boundaries_lower(self):
        ...
        evaluator = RegexEvaluator(
            name="test_lower_bound", pattern="pattern_not_found", pass_on_match=True
        )
    ...
    def test_evaluator_result_score_boundaries_upper(self):
        ...
        evaluator = RegexEvaluator(name="test_upper_bound", pattern="hello", pass_on_match=True)
    ...
    def test_exact_match_case_insensitive_boundary(self):
        ...
        evaluator = ExactMatchEvaluator(
            name="test_boundary", expected="Hello", case_sensitive=False
        )
    ...
    def test_regex_evaluation_score_at_boundaries(self):
        ...
        evaluator_pass = RegexEvaluator(
            name="test_bounds_pass", pattern="success", pass_on_match=True
        )
        ...
        evaluator_fail = RegexEvaluator(
            name="test_bounds_fail", pattern="missing", pass_on_match=True
        )
...
class TestEvaluatorBoundaryCasesMutations:
    ...
    def test_regex_ignorecase_flag_required(self):
        ...
        evaluator = RegexEvaluator(name="case_test", pattern="success", pass_on_match=True)
    ...
    def test_exact_match_with_empty_output(self):
        ...
        evaluator = ExactMatchEvaluator(name="empty_test", expected="hello", case_sensitive=False)
    ...
    def test_exact_match_case_insensitive_unicode(self):
        ...
        evaluator = ExactMatchEvaluator(name="unicode_test", expected="café", case_sensitive=False)
